...
public class MergeSortedArraySolutionTest extends MergeSortedArraySolution{
    ...
    void mergeSortedArrayByMyOneTest(){
        ...
        super.mergeSortedArrayByMyOneFailed(nums1, 3, nums2, nums2.length, target);
        int[] nums1Null = {1};
        int[] nums2Null = {};
        int[] targetNull = {1};
        super.mergeSortedArrayByMyOneFailed(nums1Null, 1, nums2Null, 0, targetNull);
    }
    ...
    @Test
    void mergeSortedArrayByExpertTwoTest(){
        int[] nums1 = {1,2,3,0,0,0};
        int[] nums2 = {2,5,6};
        int[] target = {1,2,2,3,5,6};
        super.mergeSortedArrayByExpertTwo(nums1, 3, nums2, nums2.length, target);
        int[] nums1Null = {1};
        int[] nums2Null = {};
        int[] targetNull = {1};
        super.mergeSortedArrayByExpertTwo(nums1Null, 1, nums2Null, 0, targetNull);
    }
}
