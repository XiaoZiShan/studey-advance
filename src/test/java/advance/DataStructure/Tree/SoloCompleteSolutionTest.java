package java.advance.DataStructure.Tree;
import org.junit.jupiter.api.Test;

import java.studey.advance.DataStructure.Enums.PermissionLevelEnum;
import java.studey.advance.DataStructure.Pojo.PermissionResource;
import java.studey.advance.DataStructure.Tree.SoloNode;
import java.studey.advance.DataStructure.Utils.JsonUtil;
import java.studey.advance.QuestionTypes.Tree.SoloTreeCompleteSolution;
...
public class SoloCompleteSolutionTest extends SoloTreeCompleteSolution {
    ...
    void viewCompleteSoloTree() {
        ...
        List<SoloNode> soloTree = viewCompleteSoloTree(soloList);
